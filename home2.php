...
$galeriaConsultorio = [
    ['arquivo' => 'consultorio-01.jpg', 'alt' => 'Vista do consultório com mesa de atendimento e decoração acolhedora'],
    ['arquivo' => 'consultorio-02.jpg', 'alt' => 'Sofá do consultório com almofadas verdes e ambiente acolhedor'],
    ['arquivo' => 'consultorio-03.jpg', 'alt' => 'Mesa de atendimento com livros e luz natural no consultório'],
    ['arquivo' => 'consultorio-04.jpg', 'alt' => 'Poltronas e área de atendimento do consultório'],
    ['arquivo' => 'consultorio-05.jpg', 'alt' => 'Sala de espera do consultório'],
    ['arquivo' => 'consultorio-06.jpg', 'alt' => 'Apoio de café e água do consultório'],
    ['arquivo' => 'consultorio-07.jpg', 'alt' => 'Poltronas claras em ambiente de atendimento'],
    ['arquivo' => 'consultorio-08.jpg', 'alt' => 'Poltrona verde com iluminação aconchegante'],
    ['arquivo' => 'consultorio-09.jpg', 'alt' => 'Mesa de atendimento próxima à janela'],
    ['arquivo' => 'consultorio-10.jpg', 'alt' => 'Sofá e poltrona do consultório em composição acolhedora'],
    ['arquivo' => 'consultorio-11.jpg', 'alt' => 'Poltrona verde e detalhes decorativos do consultório'],
    ['arquivo' => 'consultorio-12.jpg', 'alt' => 'Sofá em tom suave com almofadas verdes'],
    ['arquivo' => 'consultorio-13.jpg', 'alt' => 'Poltrona verde e luminária do espaço terapêutico'],
    ['arquivo' => 'consultorio-14.jpg', 'alt' => 'Sofá do consultório com visão para a área de atendimento'],
    ['arquivo' => 'consultorio-15.jpg', 'alt' => 'Detalhes da mesa de atendimento e decoração natural'],
    ['arquivo' => 'consultorio-16.jpg', 'alt' => 'Vista acolhedora do sofá e poltrona do consultório'],
    ['arquivo' => 'consultorio-17.jpg', 'alt' => 'Sofá em destaque no ambiente terapêutico'],
    ['arquivo' => 'consultorio-18.jpg', 'alt' => 'Parede decorativa e sofá do consultório'],
    ['arquivo' => 'consultorio-19.jpg', 'alt' => 'Ambiente de atendimento com sofá e decoração suave'],
];
?>
<!-- Header / Navbar -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <a href="<?= BASE_URL ?: '/' ?>" class="flex-shrink-0 flex items-center" aria-label="Ir para a página inicial">
                <img src="<?= $asset('assets/img/logo/logo-daniella-horizontal-color.svg') ?>" alt="Daniella Paes Barreto Psicologia" class="h-12 md:h-14 w-auto max-w-[220px]" decoding="async">
            </a>
...
<!-- 1. Hero Section -->
<section class="relative bg-beige pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            ...
            <div class="lg:col-span-6 lg:pr-8 text-center lg:text-left mb-12 lg:mb-0">
                ...
                <p class="text-lg text-gray-700 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
...
<section id="sobre" class="py-20 lg:py-28 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div class="mb-12 lg:mb-0 hidden lg:block">
                <div class="relative">
                    <div class="absolute inset-0 bg-olive rounded-2xl transform -translate-x-4 translate-y-4 -z-10"></div>
                    <img src="<?= $asset('assets/img/daniella02.jpeg') ?>" alt="Consultório de Psicologia" class="rounded-2xl shadow-lg object-cover h-[600px] w-full grayscale-[20%] sepia-[10%]">
                </div>
            </div>
            <div>
...
<section id="servicos" class="py-20 lg:py-28 bg-beige">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<section id="galeria" class="py-20 lg:py-28 bg-beige overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<section id="localizacao" class="py-20 lg:py-28 bg-beige">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
            ...
            <div class="p-8 lg:p-12">
                ...
                <form id="lead-whatsapp-form" class="space-y-5" action="<?= BASE_URL ?>/lead-enviar.php" method="post">
                    <div>
            ...
            <div class="h-full flex flex-col">
                ...
                <div class="h-64 bg-gray-200 relative group overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Consultório" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
...
<footer class="bg-textDark text-white py-12 border-t border-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-8 items-center text-center md:text-left">
            <!-- Brand -->
            <div>
                <img src="<?= $asset('assets/img/logo/logo-daniella-horizontal-light.svg') ?>" alt="Daniella Paes Barreto Psicologia" class="h-16 md:h-20 w-auto mx-auto md:mx-0 mb-3" loading="lazy" decoding="async">
...
<script>
    ...
    if (leadForm) {
        leadForm.addEventListener('submit', async (event) => {
            ...
            const endpoint = leadForm.getAttribute('action') || '<?= BASE_URL ?>/lead/enviar';
            ...
            try {
                ...
                try {
                    ...
                    throw new Error('O servidor não retornou JSON válido. Resposta: ' + responseText.substring(0, 180));
                }

                if (!response.ok || !resultJson || resultJson.status !== 'success') {
                    throw new Error(resultJson && resultJson.message ? resultJson.message : 'Não foi possível salvar os dados na planilha.');
                }
