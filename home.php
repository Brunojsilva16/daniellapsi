    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            ...
            <div class="lg:col-span-6 lg:pr-8 text-center lg:text-left mb-12 lg:mb-0">
                ...
                <p class="text-base text-gray-700 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="https://wa.me/5581988111601?text=Olá,%20vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20a%20terapia." target="_blank" class="bg-olive hover:bg-olive-dark text-white text-lg px-8 py-2 rounded-full font-medium transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                        <i data-lucide="calendar-check" class="w-5 h-5"></i>
                        Agendar minha consulta
                    </a>
                    <a href="#servicos" class="bg-white hover:bg-gray-50 text-olive-dark text-base px-8 py-2 rounded-full font-medium transition-all shadow-sm border border-gray-200 flex items-center justify-center">
                        Ver especialidades
                    </a>
                </div>
            </div>
...
<section id="servicos" class="py-20 lg:py-28 bg-beige">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 hyphens-auto text-justify">
            <!-- Card 1 -->
...
<section id="atendimento" class="py-20 bg-olive text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:flex lg:justify-between lg:items-center gap-12">
            ...
            <div class="lg:w-2/3 grid sm:grid-cols-2 gap-6 hyphens-auto text-justify">
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
            ...
            <div class="h-full flex flex-col">
                ...
                <div class="h-64 bg-gray-200 relative group overflow-hidden">
                    <img src="<?= $asset('assets/img/consultorio.jpeg') ?>" alt="Consultório" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-100">
